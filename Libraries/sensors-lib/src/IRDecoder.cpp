...
void IRAM_ATTR ISRforIR(void * arg) 
{
	IRDecoder* obj = (IRDecoder*)arg;
	obj->ISR_IR();
}
...
{
  pinMode(irPin, INPUT);
  attachInterruptArg(digitalPinToInterrupt(irPin), ISRforIR, this, CHANGE);
}

void IRDecoder::ISR_IR(void)
{
